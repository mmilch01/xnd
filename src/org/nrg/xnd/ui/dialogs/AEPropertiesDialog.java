...
public class AEPropertiesDialog extends Dialog
{
	...
	private boolean m_bLocalChangedNoticeShown = false;
	private String m_defSel = "";

	public AEPropertiesDialog(IShellProvider parentShell)
	{
		super(parentShell);
		// TODO Auto-generated constructor stub
	}

	public AEPropertiesDialog(Shell parentShell, String defaultSel)
	{
		super(parentShell);
		m_defSel = defaultSel;
	}
	...
	protected void configureShell(Shell newShell)
	{
		...
		newShell.setText("Configure DICOM AEs");
	}
	@Override
	...
	private void updateData(boolean bFromUI)
	{
		if (bFromUI)
		{
			...
			if (cur_ae.m_name.compareTo("local") == 0)
			{
				if (!m_bLocalChangedNoticeShown)
				{
					Utils
							.ShowMessageBox(
									"Warning",
									"Please restart XNAT Desktop for changes to take effect",
									Window.OK);
					m_bLocalChangedNoticeShown = true;
				}
			}
		} else
		{
	...
	public String getSelectedAEName()
	{
		return m_defSel;
	}
	@Override
	protected void okPressed()
	{
		...
		m_defSel = m_AENameCombo.getText();
		super.okPressed();
	}
}
